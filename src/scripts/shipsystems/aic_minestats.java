...
public class aic_minestats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	public static float MINE_RANGE = 1000f;
	
	public static final float MIN_SPAWN_DIST = 100f;
	
	public static final float LIVE_TIME = 8f;

	private static final float ARMED_TIME = 3f;

	public static final Color JITTER_COLOR = new Color(255, 56, 56,75);
	public static final Color JITTER_UNDER_COLOR = new Color(255, 170, 155,155);
