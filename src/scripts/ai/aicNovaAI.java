...
public class aicNovaAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_TIME=1.0f;
    ...
    */
    ...
    public aicNovaAI(MissileAPI missile, ShipAPI launchingShip) {
