...
public class aicScytheAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float OVERSHOT_ANGLE=270;
    
    //Time to complete a wave in seconds.
    private final float WAVE_TIME=0.1f;
    ...
    */
    ...
    public aicScytheAI(MissileAPI missile, ShipAPI launchingShip) {
