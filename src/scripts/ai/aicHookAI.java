...
public class aicHookAI implements MissileAIPlugin, GuidedMissileAI {
    ...
    private final float WAVE_AMPLITUDE=40;
    ...
    */
    ...
    public aicHookAI(MissileAPI missile, ShipAPI launchingShip) {
