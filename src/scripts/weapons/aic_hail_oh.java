...
public class aic_hail_oh implements OnHitEffectPlugin {

    private static final float EXTRA_DMG_CHANCE = 1.0f;
    private static final float MAX_EXTRA_DMG = 100f;
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit,
        ...
        if (target instanceof ShipAPI && Math.random() <= EXTRA_DMG_CHANCE) {
            ...
            engine.spawnExplosion(point, velc, EXPLOSION_COLOR, 50f, 0.40f);
        }
